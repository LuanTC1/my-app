...
// Accessible login interface with proper ARIA labels
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 space-y-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-gray-900 hover:bg-gray-800 text-white font-medium py-2 px-4 rounded-md transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
            <svg
              className="w-5 h-5"
              fill="currentColor"
          ...
          <p
            ...
            aria-live="polite"
          >
            By signing in with GitHub, you agree to our terms of service
          </p>
        </div>
        ...
        <div className="text-center text-sm text-gray-600">
          <p>
            ...
            <span className="text-gray-500">Sign in with GitHub to continue</span>
          </p>
        </div>
      </div>
    </div>
